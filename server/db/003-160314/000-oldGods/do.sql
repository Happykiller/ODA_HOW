...
VALUES
  ...
  (NOW(),'Faceless Shambler',0,'Epique','','Neutre',4,1,1,'Serviteur',@old_gods_id,'Provocation. Cri de guerre : Copie l''Attaque et la Vie d''un serviteur allié.'),
  ...
  (NOW(),'Flamme interdite',0,'Epique','','Mage',0,0,0,'Sort',@old_gods_id,'Dépense tous vos cristaux de mana. Inflige l''équivalent sous forme de dégâts à un serviteur.'),
  (NOW(),'Mutation interdite',0,'Epique','','Prêtre',0,0,0,'Sort',@old_gods_id,'Dépense tous vos cristaux de mana. Invoque un serviteur aléatoire de même coût.'),
  (NOW(),'Soin Interdit',0,'Epique','','Paladin',0,0,0,'Sort',@old_gods_id,'	Dépense tous vos cristaux de mana. Rend deux fois l''équivalent en points de vie.'),
  (NOW(),'Tisse-ambre klaxxi',0,'Rare','','Druide',4,4,5,'Serviteur',@old_gods_id,'Cri de guerre : gagne +5 PV si votre C''thun a au moins 10 Attaque.'),
  ...
  (NOW(),'Renoncer aux ténèbres',0,'Epique','','Démoniste',2,0,0,'Sort',@old_gods_id,'Remplace votre pouvoir héroïque et vos cartes Démoniste par ceux d''une autre classe. Les cartes coûtent (1) de moins.'),
