...
VALUES
  ...
  (NOW(),'Shadowcaster',0,'Épique','','Voleur',5,4,4,'Serviteur',@old_gods_id,'Cri de guerre : Choisissez un serviteur allié. En place une copie 1/1 qui coûte (1) dans votre main'),
